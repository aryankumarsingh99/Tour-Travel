...
const PartnerCard = ({ name, image, info }) => {
  ...
  return (
    <div className="relative flex-shrink-0 w-[260px] sm:w-[300px] md:w-80 mx-3 sm:mx-4">
      <div
        className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 cursor-pointer"
      ...
      >
        ...
        <div className="p-5 sm:p-6 bg-gradient-to-br from-blue-700 to-blue-800">
        ...
        >
          <div className="bg-blue-900/95 backdrop-blur-sm p-5 sm:p-6 border-t border-white/10">
