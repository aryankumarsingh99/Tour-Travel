...
export default function CarDetails() {
  ...
  return (
    ...
    <div className="px-4 sm:px-5 md:px-6 lg:px-8 xl:px-16 py-6 md:py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 md:mb-8 gap-3 md:gap-4">
          <h1 className="text-base md:text-xl lg:text-2xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">XYZ CARS</h1>
        ...
        <div className="flex items-center gap-2 md:gap-3 lg:gap-4 mb-6 md:mb-8 group">
          ...
          <h2 className="text-lg md:text-xl lg:text-2xl font-semibold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent group-hover:from-blue-600 group-hover:to-cyan-600 transition-all duration-300">Tata Sierra</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8 lg:gap-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs md:text-sm">
              ...
              <div className="p-3 rounded-xl hover:shadow-md transition-all duration-300 hover:scale-105 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">Charging</p>
                </div>
              </div>
              <div className="p-3 rounded-xl hover:shadow-md transition-all duration-300 hover:scale-105 flex items-center gap-2">
              ...
              <div className="p-3 rounded-xl hover:shadow-md transition-all duration-300 hover:scale-105 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">Large Space</p>
                </div>
              </div>
              <div className="p-3 rounded-xl hover:shadow-md transition-all duration-300 hover:scale-105 flex items-center gap-2">
          ...
          <div className="flex flex-col gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-[26px] p-6 md:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100">
              <h3 className="font-semibold mb-4 md:mb-6 text-sm md:text-base bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Your trip</h3>
              ...
              <div className="grid grid-cols-2 gap-y-4 md:gap-y-6 gap-x-4 md:gap-x-6 text-xs md:text-sm">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                  />
                </div>
                <div>
            ...
            {/* PRICE DETAILS */}
            <div className="bg-white rounded-[26px] p-6 md:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100">
              <h3 className="font-semibold mb-4 md:mb-6 text-sm md:text-base bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Price Details</h3>
  ...
  BOOK NOW
        ...
        <div className="mt-8 md:mt-12 bg-gray-50 border-l-4 border-blue-700 rounded-xl p-6 md:p-10">
          <h3 className="font-semibold mb-4 md:mb-6 text-sm md:text-base text-gray-900">
            Vehicle Features
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 text-xs md:text-sm">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li><Wifi className="inline w-4 h-4 mr-1" /> WiFi Hotspot</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li>Pet Friendly <PawPrint className="inline w-4 h-4 ml-1" /></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><LifeBuoy className="inline w-4 h-4 mr-1" /> Roadside Assistance</li>
                <li><HeartHandshake className="inline w-4 h-4 mr-1" /> 24/7 Support</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        {/* CUSTOMER REVIEWS */}
        <div className="mt-12">
          <h3 className="font-semibold mb-4 md:mb-6 text-sm md:text-base">Customer Reviews</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
            <div className="bg-white rounded-xl p-6 shadow-md">
              <div className="flex items-center gap-2 mb-2"><Star className="w-4 h-4 text-yellow-400" /> 5.0</div>
              <p className="text-gray-700 mb-2">"Amazing ride! The car was super clean and comfortable. Highly recommend."</p>
              <span className="text-xs text-gray-500">- Priya S.</span>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md">
              <div className="flex items-center gap-2 mb-2"><Star className="w-4 h-4 text-yellow-400" /> 4.8</div>
              <p className="text-gray-700 mb-2">"Bluetooth and WiFi made our trip so much easier. Great service!"</p>
              <span className="text-xs text-gray-500">- Rahul V.</span>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md">
              <div className="flex items-center gap-2 mb-2"><Star className="w-4 h-4 text-yellow-400" /> 4.9</div>
              <p className="text-gray-700 mb-2">"Roadside assistance was prompt and helpful. Will book again!"</p>
              <span className="text-xs text-gray-500">- Anita P.</span>
            </div>
          </div>
        </div>
        ...
        {/* FAQ SECTION */}
        <div className="mt-12">
          <h3 className="font-semibold mb-4 md:mb-6 text-sm md:text-base">Frequently Asked Questions</h3>
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-4 shadow">
              <div className="flex items-center gap-2 mb-2"><HelpCircle className="w-4 h-4 text-blue-400" /> <span className="font-medium">Is fuel included in the rental price?</span></div>
              <p className="text-gray-600 text-xs">No, fuel charges are extra and based on usage.</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow">
              <div className="flex items-center gap-2 mb-2"><HelpCircle className="w-4 h-4 text-blue-400" /> <span className="font-medium">Can I bring my pet?</span></div>
              <p className="text-gray-600 text-xs">Yes, our cars are pet-friendly. Please mention while booking.</p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow">
              <div className="flex items-center gap-2 mb-2"><HelpCircle className="w-4 h-4 text-blue-400" /> <span className="font-medium">What if I need help during my trip?</span></div>
              <p className="text-gray-600 text-xs">We offer 24/7 roadside assistance and customer support.</p>
            </div>
          </div>
        </div>
